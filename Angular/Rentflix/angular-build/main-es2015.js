...
let config = new angularx_social_login__WEBPACK_IMPORTED_MODULE_26__["AuthServiceConfig"]([
    {
...
let LoginComponent = class LoginComponent {
    ...
    signInWithGoogle() {
        this.authService.signIn(angularx_social_login__WEBPACK_IMPORTED_MODULE_5__["GoogleLoginProvider"].PROVIDER_ID).then(res => { this.loginService.registerGoogleUser(res.email, res.firstName, ''); });
    }
    signOut() {
...
let LoginService = class LoginService {
    ...
    registerGoogleUser(email, username, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const bool = true;
